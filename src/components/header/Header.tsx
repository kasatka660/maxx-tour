  ...
  return (
    ...
    >
      ...
      <div className="mx-8 flex items-center justify-between">
        <Link href="/" className="header-logo" aria-label="MaxxTour.by">
          {/* eslint-disable-next-line @next/next/no-img-element -- the logo swaps
              between two SVGs of different aspect ratios; next/image would need
              fixed dimensions per source for no benefit on an inlined asset. */}
          <img
            src={(isScrolled ? logoUrl : logoNoTextUrl).src}
            alt="MaxxTour Logo"
